...
class PendingExport implements ShouldAutoSize, FromView , WithEvents, WithTitle
{
    /**
    ...
    */
    ...
    // 	$sheets[] = new PMIRecordsSheet($this->date, $this->pmi_employees, 'PMI EMPLOYEES', 0);
    // 	$sheets[] = new PMIRecordsPerSectionSheet($this->date, $this->pmi_employees_per_section, 'PMI EMPLOYEES PER SECTION', 0);
