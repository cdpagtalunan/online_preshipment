...
@import url(https://fonts.googleapis.com/css?family=Merriweather:400,700);
    ...
    @media only screen and (max-width:480px) {
      ...
      <img height="auto" src="https://s3-eu-west-1.amazonaws.com/topolio/uploads/613c31a022048/1631334831.jpg" style="border:0;display:block;outline:none;text-decoration:none;height:auto;width:100%;font-size:13px;" width="522">
      ...
      <p style="font-family: Ubuntu, Helvetica, Arial; border-top: solid 3px #000000; font-size: 1; margin: 0px auto; width: 100%;">
      </p>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;"><p style="font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-family: Merriweather, Georgia, serif; font-size: 30px;"><strong>ISS Billing/License Notification</strong></span></p></div>
      ...
      <div style="font-family:Ubuntu, Helvetica, Arial, sans-serif;font-size:11px;line-height:1.5;text-align:left;color:#000000;"><p style="font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 22px;"><strong>{{ $name }}</strong> will due on <strong>{{ $date }}</strong></span></p>
<p style="font-family: Ubuntu, Helvetica, Arial; text-align: center;"><span style="font-size: 22px;">Person in Charge: <strong>{{ $person }}</strong></span></p></div>
